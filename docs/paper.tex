...
DOI: \href{https://doi.org/10.13140/RG.2.2.32211.13607}{10.13140/RG.2.2.32211.13607}}}
...
The full source code, trained checkpoints, cached DistilBERT/PCA embeddings, IBM Quantum job logs, and all paper figures are publicly available at
\href{https://github.com/RsGoksel/quantum-encoding-nlp}{\texttt{github.com/RsGoksel/quantum-encoding-nlp}}
under the MIT License. The repository includes scripts to fully reproduce every result reported in this paper.
...
\textbf{Funding.} This research received no specific grant from any public, commercial, or not-for-profit funding agency.\\
\textbf{IBM Quantum Access.} Hardware experiments were conducted under the IBM Quantum Open Plan (10\,min/month free tier).
